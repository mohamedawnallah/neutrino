...
//
// NOTE: We assume the iterator is already initialized with Reset() by the
// caller, as we don't know the start/end indices here.
func (v *blockHeadersImportSourceValidator) Validate(
	ctx context.Context, iterator HeaderIterator,
